...
export default function LoginPage() {
  ...
  // Function để điền demo credentials
    ...
    <>
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-gradient-to-br from-[#1B1F3B] via-[#0B0F19] to-black min-h-screen">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div className="mb-4 p-3 bg-blue-500/10 border border-blue-500 rounded-md text-blue-400 text-sm">
            <div className="flex justify-between items-center">
              <div>
                <p className="font-semibold">Demo Account:</p>
                <p>admin@hocdanit.com / 123456</p>
              </div>
              <button
                type="button"
